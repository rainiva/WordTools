...
namespace WordTools
{
    ...
    public static class Theme
    {
        ...
        public static Button CreateButton(string text, ButtonStyle style = ButtonStyle.Default)
        {
            ...
            btn.EnabledChanged += (sender, e) =>
            {
                ...
                if (button != null)
                {
                    ...
                    {
                        button.BackColor = Colors.ButtonDisabled;
                        button.ForeColor = Colors.TextDisabled;
                        button.FlatAppearance.BorderColor = Colors.ButtonDisabledBorder;
        ...
        private static void ApplyButtonStyle(Button btn, ButtonStyle style)
        {
            switch (style)
            {
                ...
                case ButtonStyle.Success:
                    ...
                    break;
                default:
                    btn.BackColor = Colors.ButtonDefault;
        ...
        /// 创建分隔线
        /// </summary>
        /// <param name="width">分隔线宽度</param>
        /// <returns>配置好的分隔线 Label 控件</returns>
